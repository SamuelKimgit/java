...
public class IDFormatExceptionMain implements LoggerManager {
	...
	public void setUserID(String userID) throws IDFormatException {
		...
		if(null == userID) {
			...
			throw new IDFormatException("아이디는 8자이상 20자이하로 사용하세요");
		}
		this.userID = userID;
	}
	...
	public static void main(String[] args) {
		...
		//String id = null;
		//String id = "a123456";
		String id = "a123456789b123456789c123";
...
// String id = null;
// - IDFormatException: 아이디는 null일수 없습니다.
// - 프로그램 종료

// String id = "a123456"
// - IDFormatException: 아이디는 8자이상 20자이하로 사용하세요
// - 프로그램 종료
