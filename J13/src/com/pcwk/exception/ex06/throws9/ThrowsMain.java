...
//	자신을 호출한 쪽으로 예외 처리에 대한 책임을 넘기는 것
	...
	public static void main(String[] args) throws Exception {
		methodA(); // throws Exception 을 줌으로 써 예외 회피.
	}
}
//2022-02-21 11:20:45,543 DEBUG [main] cmn.LoggerManager (ThrowsMain.java:26)     - methodA()
//Exception in thread "main" java.lang.Exception: 메서드A 예외 발생!
//	at com.pcwk.exception.ex06.throws9.ThrowsMain.methodA(ThrowsMain.java:27)
//	at com.pcwk.exception.ex06.throws9.ThrowsMain.main(ThrowsMain.java:31)
