...
//		Integer i = new Integer(100);
		...
		System.out.println(Integer.MAX_VALUE); // 2147483647 (0 부터 시작이므로 -1 됨)
		System.out.println("SIZE: " + Integer.SIZE + "bit"); // SIZE: 32bit
		System.out.println("BYTES: " + Integer.BYTES + "BYTES"); // BYTES: 4BYTES
