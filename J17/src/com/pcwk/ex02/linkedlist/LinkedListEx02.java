...
public class LinkedListEx02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("lectureList: " + lectureList); // lectureList: [C, JAVA, ORACLE, WEB, SPRING, C]
		
		// 데이터 삭제 : index
		String removeLecture = lectureList.remove(0);
		System.out.println("lectureList: " + lectureList); // lectureList: [JAVA, ORACLE, WEB, SPRING, C]
		System.out.println("removeLecture: " + removeLecture); // 삭제된 데이터 보기 "C"
