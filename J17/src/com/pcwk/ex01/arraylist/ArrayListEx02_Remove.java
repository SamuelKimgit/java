...
public class ArrayListEx02_Remove {
	...
	// 데이터 삭제
	// 다 건 삭제시 뒤에서부터 삭제해야 한다.
	public static void main(String[] args) {
		// C, JAVA, ORACLE, WEB, SPRING, C
		// 데이터 중복 허용 : 데이터 값 "C" 가 2개이지만 가능
		...
		System.out.println("removeLecture: " + removeLecture); // removeLecture: C
		
		// 데이터로 삭제
		lectureList.remove("C");
		System.out.println("lectureList:" + lectureList); // lectureList:[ORACLE, WEB, SPRING, C]
		
		// 데이터 모두 삭제
		lectureList.clear();
		System.out.println("lectureList:" + lectureList); // lectureList:[]
	}
}
//	lectureList:[C, JAVA, ORACLE, WEB, SPRING, C]
//	removeLecture: C
